            ...
            <div class="card-body">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ">
                        ...
                        <div class=" fw-semibold">
                            ...
                            <div class="fs-6 text-gray-700 ">Your payment was declined. To start using
                                tools, please <a href="#" class="fw-bold" data-bs-toggle="modal"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="fs-6 text-gray-600 fw-semibold mb-6 mb-lg-15">We will send you a
                            notification upon Subscription expiration </p>
                        <!--end::Heading-->
                    ...
                    <div class="col-lg-5">
                        ...
                        <!--begin::Description-->
                        <div class="fs-6 text-gray-600 fw-semibold mb-10">14 Users remaining until your
                            plan requires update</div>
                        <!--end::Description-->
                    ...
                    <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a id="kt_billing_paypal_tab" class="nav-link fs-5 fw-bold"
                                data-bs-toggle="tab" role="tab" href="#kt_billing_paypal">
                                Paypal
                            </a>
                        </li>
                        <!--end::Tab item-->
...
<h3 class=" mb-5">My Cards</h3>
                            ...
                            <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                ...
                                <div class="d-flex flex-column py-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Icon-->
                                        <img src="https://preview.keenthemes.com/metronic8/demo9/assets/media/svg/card-logos/visa.svg"
                                            alt="" class="me-4" />
                                        <!--end::Icon-->
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-6 fw-semibold text-gray-500">Card expires at
                                                09/24</div>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                        ...
                        <div class="col-xl-6" data-kt-billing-element="card">
                            ...
                            <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                ...
                                <div class="d-flex flex-column py-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Icon-->
                                        <img src="https://preview.keenthemes.com/metronic8/demo9/assets/media/svg/card-logos/american-express.svg"
                                            alt="" class="me-4" />
                                        <!--end::Icon-->
                        ...
                        <div class="col-xl-6" data-kt-billing-element="card">
                            ...
                            <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
                                ...
                                <div class="d-flex flex-column py-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Icon-->
                                        <img src="https://preview.keenthemes.com/metronic8/demo9/assets/media/svg/card-logos/mastercard.svg"
                                            alt="" class="me-4" />
                                        <!--end::Icon-->
                            ...
                            <div
                                ...
                                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                    ...
                                    <div class="mb-3 mb-md-0 fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700 pe-7">Please carefully read <a
                                                href="#" class="fw-bold me-1">Product Terms</a> adding
                ...
                <div id="kt_billing_paypal" class="tab-pane fade" role="tabpanel"
                    ...
                    <!--begin::Description-->
                    <div class="text-gray-600 fs-6 fw-semibold mb-5">To use PayPal as your payment
                        method, you will need to make pre-payments each month before your bill is due.
                    </div>
                    <!--end::Description-->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                <!--begin::Content-->
                                <div class="mb-3 mb-md-0 fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">This is a very important note!
                                    </h4>

                                    <div class="fs-6 text-gray-700 pe-7">Writing headlines for blog
                                        posts is much science and probably cool audience</div>
                                </div>
                                <!--end::Content-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    <td>Nov 01, 2020</td>
                                    <td><a href="#">Invoice for Ocrober 2025</a></td>
                                    <td>$123.79</td>
                                    <td><a href="#"
                                ...
                                <tr>
                                    <td>Oct 08, 2020</td>
                                    <td><a href="#">Invoice for September 2025</a></td>
                                    <td>$98.03</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Aug 01, 2020</td>
                                    <td><a href="#">Invoice for July 2025</a></td>
                                    <td>$142.80</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Jul 01, 2020</td>
                                    <td><a href="#">Invoice for June 2025</a></td>
                                    <td>$123.79</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Jun 01, 2020</td>
                                    <td><a href="#">Invoice for May 2025</a></td>
                                    <td>$123.79</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    <td>Dec 01, 2021</td>
                                    <td><a href="#">Billing for Ocrober 2025</a></td>
                                    <td>$250.79</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Oct 08, 2021</td>
                                    <td><a href="#">Statements for September 2025</a></td>
                                    <td>$98.03</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Jul 01, 2021</td>
                                    <td><a href="#">Statements for June 2025</a></td>
                                    <td>$123.79</td>
                                    <td><a href="#"
                                            class="btn btn-sm btn-light btn-active-light-primary">PDF</a>
                                    </td>
