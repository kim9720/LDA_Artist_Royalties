...
@section('content')
                ...
                <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                    <div class="card">
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            <div class="d-flex flex-wrap gap-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-4 me-lg-7">
                                    <input class="form-check-input" type="checkbox" id="checkAllComplaints"
                                           data-kt-check="true" data-kt-check-target="#kt_complaints_listing .form-check-input" value="1" />
                                </div>
                                <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary reload-table"
                                ...
                                <a href="#"
                                    ...
                                    <i class="fa fa-trash fs-2 text-danger"><span class="path1"></span><span
                        ...
                        <div class="card-body p-3">
                            <table class="table align-middle border rounded table-row-dashed table-responsive table-hover fs-6 gy-5 my-0 p-3"
    ...
    $('.delete-complaints').on('click', function(e) {
        ...
        var selectedComplaints = $('#kt_complaints_listing').DataTable().$('.form-check-input:checked');
        ...
        Swal.fire({
            title: 'Are you sure?',
            html: 'You are about to delete <strong>' + selectedComplaints.length + '</strong> complaint(s).<br><br>This action cannot be undone.',
            icon: 'warning',
            ...
            preConfirm: function() {
                return $.ajax({
                    ...
                    Swal.showValidationMessage(
                        'Request failed: ' + (jqXHR.responseJSON?.message || jqXHR.statusText)
                    );
                });
            }
            ...
            if (result.isConfirmed && result.value.success) {
                Swal.fire({
                    title: 'Deleted!',
                    html: 'Successfully deleted <strong>' + selectedComplaints.length + '</strong> complaint(s).',
                    icon: 'success',
                    confirmButtonColor: '#3085d6',
                }).then(function() {
